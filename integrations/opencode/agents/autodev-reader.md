...
4. Run the reader `accept` command from the role contract using the same configured launcher. This accept call is mandatory and is the final workflow action of a successful Reader invocation; do not emit success before it succeeds.
