...
class EvalHarnessTests(unittest.TestCase):
    ...
    def test_two_profiles_compare_all_replay_cases_without_model_calls(self):
        ...
        for case in cases.values():
            for name in ("legacy-command", "mixed-groq-openrouter"):
    ...
    def test_repair_and_no_change_metrics_are_deterministic(self):
        ...
        no_change = eval_harness.load_replay(
            ...
            profiles["mixed-groq-openrouter"],
            cases_path=cases_path,
        )
    ...
    def test_parser_requires_two_profiles_at_runtime(self):
        parser = eval_harness.build_parser()
        args = parser.parse_args(["--profile", "legacy-command", "--profile", "mixed-groq-openrouter"])
        self.assertEqual(args.profiles, ["legacy-command", "mixed-groq-openrouter"])
