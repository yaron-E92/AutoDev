...
is_ignored_path(){ local p="${1#./}"; case "/$p/" in */.git/*|*/.autodev-run/*|*/bin/*|*/obj/*|*/node_modules/*|*/dist/*|*/build/*|*/coverage/*|*/.vs/*|*/.idea/*|*/.vscode/*|*/.venv/*|*/venv/*|*/__pycache__/*) return 0;; esac; [[ "$p" == "memory.md" || "$p" == */memory.md ]]; }
